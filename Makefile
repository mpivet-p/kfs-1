...
KERNEL_DIR=kernel/
KERNEL_FILES=kernel.c string.c term.c init_term.c gdt.c printk.c idt.c exception_handler.c puts.c irq_handler.c install_irq.c system_timer.c keyboard.c shell.c readline.c print_stack.c
